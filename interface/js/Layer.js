...
WireIt.Layer.prototype = {
   ...
   addContainer: function(containerConfig) {
	...
	// FIXME : Does this add a unique ID?
	// https://groups.google.com/d/topic/wireit/AqTstl9Ee9g/discussion
	//container.id = this.idGenerator;
	//	this.idGenerator++;
	
	// https://groups.google.com/d/topic/wireit/y0bjRVuPHeA/discussion
